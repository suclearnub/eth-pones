...
contract horse {
    ...
    function new_pony(string _name, uint8 _mane_1, uint8 _mane_2, uint8 _mane_3, uint8 _coat_1, uint8 _coat_2, uint8 _coat_3) public payable {
        ...
        function modify_pony(uint8 pony_id, string _name, uint8 _mane_1, uint8 _mane_2, uint8 _mane_3, uint8 _coat_1, uint8 _coat_2, uint8 _coat_3) public payable {
    ...
    function offer(uint8 pony_id) public payable {
        ...
        if (pony[pony_id].current_offer_address != 0x0) {
            // If not the first bid, return the offer deposit to the last person
    ...
    function accept_offer(uint8 pony_id) public {
        require(msg.sender == pony[pony_id].owner);
        require(pony[pony_id].current_offer_address != 0x0);
        var amount_to_send = pony[pony_id].current_offer;
        pony[pony_id].current_offer = 0;
